      ...
      items={[
        {
          ...
          description:
            "Aldol, Claisen, Michael, Wittig, Grignard, and related reactions.",
        },
        {
          title: "Cross-coupling reactions",
          description:
            "Suzuki, Heck, Sonogashira, Negishi, Stille, Buchwald–Hartwig, and more.",
        },
        {
          title: "Cycloadditions and pericyclic reactions",
          description:
            "Diels–Alder, electrocyclic reactions, sigmatropic rearrangements, and related chemistry.",
        },
        {
          title: "Oxidations and reductions",
          description:
            "Named transformations that change oxidation state with useful selectivity.",
        },
        {
          title: "Rearrangements",
          description:
            "Beckmann, Baeyer–Villiger, Claisen, Cope, pinacol, Wagner–Meerwein, and others.",
        },
        {
          title: "A–Z index",
          description:
            "An alphabetical index will grow as reviewed reaction pages are published.",
        },
      ]}
    />
  );
