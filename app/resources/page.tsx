...
export default function ResourcesPage() {
  return <SectionLanding eyebrow="Reference library" title="Study and laboratory resources" description="This section will collect high-value supporting material that complements lessons and reference pages." heroContent={<ResourcesDiagram />} items={[
