...
import { compileE2Mechanism, compileSn2Mechanism } from "@/content/mechanisms/authoring";
    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="rounded-3xl border border-emerald-200 bg-emerald-50 p-6 sm:p-8">
        ...
        <p className="mt-3 max-w-3xl leading-7 text-slate-700">
          These generated mechanisms use semantic atom, bond, and lone-pair anchors to compile electron-flow arrows, then render through the existing trusted SN2 and E2 canvases and MechanismPlayerEngine. The original mechanism pages are unchanged.
        </p>
