      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-6 sm:py-18 lg:px-8">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">
            Practise electron counting, bond orders, lone pairs, octets, and
            formal charges using three introductory molecules.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-5 py-12 sm:px-6 lg:px-8">
        ...
        <section className="mt-12 grid gap-5 md:grid-cols-3">
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Hydrogen needs two electrons. Carbon, nitrogen, and oxygen in
              these examples are most stable with eight electrons around them.
            </p>
          </article>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <h2 className="mt-2 text-xl font-bold text-slate-950">
              Minimise formal charge
            </h2>

            <p className="mt-3 text-sm leading-6 text-slate-600">
              The tool recalculates formal charge after every change, helping
              you compare plausible structures rather than guessing.
            </p>
          </article>
        </section>
      </div>
