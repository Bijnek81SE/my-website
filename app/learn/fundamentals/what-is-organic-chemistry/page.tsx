  ...
  return (
    ...
    >
      ...
      <LessonSection id="carbon" title="What makes carbon unique?">
        <p>
          Carbon is especially versatile because a neutral carbon atom can form
          four covalent bonds. It can bond strongly to other carbon atoms and to
          elements such as hydrogen, oxygen, nitrogen, sulfur, phosphorus, and
          the halogens.
        </p>
        ...
        <ul className="mt-6 list-disc space-y-3 pl-7 marker:text-blue-700">
          ...
          <li>
            Carbon-carbon bonds are strong enough to create stable molecules.
          </li>
          <li>
            Different three-dimensional arrangements can produce compounds with
      ...
      <LessonSection id="classes" title="Major classes of organic compounds">
        <p>
          Organic compounds are commonly grouped according to their functional
          groups. A functional group is a specific arrangement of atoms that
          strongly influences a molecule&apos;s properties and reactions.
        </p>
      ...
      <LessonSection id="importance" title="Why organic chemistry matters">
        <div className="space-y-5">
          ...
          <div>
            ...
            <p className="mt-2">
              Plastics, synthetic fibres, coatings, adhesives, dyes, fuels, and
              many advanced materials are organic compounds or polymers.
            </p>
          </div>
        </div>
      </LessonSection>
      ...
      <LessonSection id="misconceptions" title="Common misconceptions">
        <div className="space-y-5">
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-5">
            ...
            <p className="mt-2">
              In chemistry, organic compounds may be natural or synthetic. The
              term does not mean that a substance was produced without human
              intervention.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-5">
            ...
            <p className="mt-2">
              Several carbon compounds, including carbon dioxide and carbonates,
              are conventionally classified as inorganic.
            </p>
          </div>
        </div>
      </LessonSection>
