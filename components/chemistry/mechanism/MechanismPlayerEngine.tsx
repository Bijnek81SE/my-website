...
export type MechanismPlayerMode =
  | "learn"
  | PracticeSessionMode;
  ...
  useMemo(
    () =>
      assertValidMechanismDefinition({
        ...
        questions,
        reactionData:
          validation.reactionData,
        getSceneForStep:
          validation.getSceneForStep,
      }),
    [
      questions,
      steps,
  ...
  return (
    <div className="space-y-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p
            className={`text-sm font-semibold uppercase tracking-[0.16em] ${classes.text}`}
          >
            Reaction mechanism
            player
          </p>
      ...
      {isLearnMode ? (
        ...
        <>
          <PracticeEngine
            ...
            sessionMode={mode}
            revealMessage={getRevealMessage(
              step,
              index,
            )}
            onRetryExam={
