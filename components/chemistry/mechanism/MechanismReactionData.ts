...
export const e1ReactionData = defineReactionData<E1PracticeTarget>({
  ...
  hotspots: [
    { id: "e1-water", target: "water-base", label: "Select the water molecule acting as a base", scenes: ["deprotonation"], geometry: { shape: "rect", x: 58, y: 52, width: 112, height: 90, rx: 16 } },
    ...
    { id: "e1-beta-h", target: "beta-hydrogen", label: "Select the beta hydrogen", scenes: ["deprotonation"], geometry: { shape: "circle", cx: 508, cy: 102, r: 42 } },
