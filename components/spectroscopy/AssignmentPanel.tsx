...
export default function AssignmentPanel({ assignment, atomLabels }: Props) {
  return (
    <aside className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm" aria-live="polite">
      <p className="text-xs font-semibold uppercase tracking-[0.14em] text-emerald-700">Signal assignment</p>
      {assignment ? (
        <>
          ...
          <div className="mt-4 rounded-xl bg-emerald-50 p-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-emerald-800">Assigned structure environment</p>
